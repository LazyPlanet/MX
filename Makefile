...
BASE_OBJ=WorldSession.o MessageDispatcher.o Protocol.o Player.o World.o Asset.o Room.o Game.o Config.o TaskScheduler.o PlayerMatch.o MXLog.o MessageFormat.o
SUB_OBJ=Item/*.o
